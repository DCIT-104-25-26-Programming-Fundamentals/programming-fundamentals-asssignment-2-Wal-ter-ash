...
void displayStudents(const vector<Student>& students) {
    ...
    cout << left << setw(20) << "Name" << setw(10) << "ID" << setw(20) << "Scores" << "Average" << endl;
    cout << string(60, '-') << endl;
    ...
    for (const Student& student : students) {
        ...
        cout << setw(10) << setprecision(2) << fixed << calculateAverage(student.scores) << endl;
    }
}
...
void calculateAverageForStudent(const vector<Student>& students) {
    ...
    for (const Student& student : students) {
        if (student.id == targetId) {
            cout << student.name << "'s average score: " << fixed << setprecision(2)
